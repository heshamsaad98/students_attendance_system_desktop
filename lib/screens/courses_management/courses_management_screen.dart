...
import 'components/add_new_course.dart';
import 'components/courses_data_source.dart';

class CoursesManagementScreen extends StatelessWidget {
  CoursesManagementScreen({Key? key}) : super(key: key);
      ...
      child: Column(
        children: [
          CustomHeaderScreens(
            ...
            functionAddButton: () {
              navigateTo(context, const AddNewCourse());
            },
            functionEditButton: () {},
              ...
              children: [
                ...
                Expanded(
                  child: CustomDataTable(
                    ...
                    source: CoursesDataSource(context),
                  ),
                ),
              ],
            ),
